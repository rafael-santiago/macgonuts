...
CUTE_TEST_CASE(macgonuts_get_dns_qname_from_ethernet_frame_tests)
    const unsigned char eth_ip4[] = {
        0x08, 0x00, 0x27, 0x9E, 0xFE, 0xD9, 0x08, 0x00, 0x27, 0x20, 0x4B, 0x31, 0x08, 0x00, 0x45, 0x00,
        0x00, 0x49, 0xE3, 0x69, 0x00, 0x00, 0x40, 0x11, 0x0B, 0x5B, 0xC0, 0xA8, 0x05, 0x8E, 0xC0, 0xA8,
        0x05, 0x01, 0x82, 0x23, 0x00, 0x35, 0x00, 0x35, 0xCA, 0x6E, 0x07, 0xDC, 0x01, 0x00, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x03, 0x77, 0x77, 0x77, 0x08, 0x66, 0x61, 0x6B, 0x65, 0x62,
        0x6F, 0x6F, 0x6B, 0x03, 0x63, 0x6F, 0x6D, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x29, 0xFF,
        0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
    };
    const unsigned char eth_ip6[] = {
        0x08, 0x00, 0x27, 0xE5, 0x9B, 0x4A, 0x08, 0x00, 0x27, 0x97, 0x64, 0x91, 0x86, 0xDD, 0x60, 0x0B,
        0xC3, 0x27, 0x00, 0x35, 0x11, 0x40, 0x20, 0x01, 0x0D, 0xB8, 0x00, 0x00, 0xF1, 0x01, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x20, 0x01, 0x0D, 0xB8, 0x00, 0x00, 0xF1, 0x01, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x54, 0xFE, 0x00, 0x35, 0x00, 0x35, 0x64, 0xC9, 0xE8, 0xF0,
        0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x03, 0x77, 0x77, 0x77, 0x08, 0x66,
        0x61, 0x6B, 0x65, 0x62, 0x6F, 0x6F, 0x6B, 0x03, 0x63, 0x6F, 0x6D, 0x00, 0x00, 0x1C, 0x00, 0x01,
        0x00, 0x00, 0x29, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

    };
    char *qname = NULL;
    CUTE_ASSERT(macgonuts_get_dns_qname_from_ethernet_frame(NULL, 1<<10) == NULL);
    CUTE_ASSERT(macgonuts_get_dns_qname_from_ethernet_frame(eth_ip4, 13) == NULL);
    qname = macgonuts_get_dns_qname_from_ethernet_frame(eth_ip4, sizeof(eth_ip4));
    CUTE_ASSERT(qname != NULL);
    CUTE_ASSERT(strcmp(qname, "www.fakebook.com") == 0);
    free(qname);
    qname = macgonuts_get_dns_qname_from_ethernet_frame(eth_ip6, sizeof(eth_ip6));
    CUTE_ASSERT(qname != NULL);
    CUTE_ASSERT(strcmp(qname, "www.fakebook.com") == 0);
    free(qname);
CUTE_TEST_CASE_END
